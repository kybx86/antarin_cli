...
class Config(cparser.SafeConfigParser):
	...
	def initialize_config(self):
		...
		self.write_to_config('project','')
		self.write_to_config('projectname','')
		self.write_to_config('instance','')
		self.write_to_config('instance_id','')
	...
	def update(self,username,token):
		...
		self.write_to_config('project','0')
		self.write_to_config('instance','0')
