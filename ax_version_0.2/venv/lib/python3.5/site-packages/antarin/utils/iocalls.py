...
def print_summary(message,env):
	...
	if env == 'filesystem':
		...
		cl.out(cl.blue(cl.bold('\n\tStorage Use: ')) + cl.blue('{0} / {1}').format(summary['data_storage_used'], summary['data_storage_available']))
		# print_text_bold('\n\tAntarin ID: ')
		# cl.blue(summary_file['username'])
		# print_text_bold('\n\tStorage Use: ')
		# cl.blue('%s / %s' %(summary_file['data_storage_used'], summary_file['data_storage_available']))
		# print('\n')
